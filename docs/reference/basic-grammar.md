...
$wi and $mu are markers that apply to an arbitrary amount of words (often one, but can be more). $wi forces words into **modifiers**, and is often used in the construction $wi $no to negate adjectives.
