...
This guide assumes you have some familiarity with the Kokanu vocabulary. Words that directly affect the grammar are explained here in the guide, but other words used in the example sentences will not. You can **click** on any described Kokanu word to see a definition of that word, and you can look up other words using the [dictionary](https://dictionary.kokanu.com/).
...
|-|-|-|
| [ɞ̄ȷ ɞı]{.red} [ʋȷ ɞx̄]{.green}: | [men mi]{.red} [le makan]{.green}.<br> | [I]{.red} [eat]{.green}. |
...
|Likanu|Latin script|English|
|-|-|-|
| [ɞ̄ȷ ɞı]{.red} [ʋȷ ɞx̄]{.green} **ɕıxı**{.yellow} [ōı xſɕʃɤı]{.blue} **ɞx̄**{.magenta}: | [men mi]{.red} [le makan]{.green} **wiki**{.yellow} [in kuwosi]{.blue} **makan**{.magenta}. | [I]{.red} **quickly**{.yellow} [eat]{.green} an **edible**{.magenta} [fruit]{.blue}. |

Check out the [Word Derivations](word-derivations.md) guide for more info.
...
|Likanu|Latin script|English|
|-|-|-|
| [ɕıɂ ɞʃʌʃ]{.yellow} [ōı ɞx̄]{.blue} [ʋȷ ʋ̄ſ ʌɂʋı]{.green} [ɞ̄ȷ ɞı]{.red}: | [wija moto]{.yellow} [in makan]{.blue} [le lun tajali]{.green} [men mi]{.red}. | [I]{.red} [prepare]{.green} [food]{.blue} [using fire]{.yellow}. / [I]{.red} [cook]{.green} [food]{.blue}. |
...
|Likanu|Latin script|English|
|------|------------|-------|
|xſɕʃɤı [ɂȷ]{.green} [ɵ ɞı]{.yellow} [ɕ]{.magenta} [ɵ̄ſɤı]{.red} | kuwosi [je]{.green} [ha mi]{.yellow} [wa]{.magenta} [hunsi]{.red} | [us two]{.yellow}[’s]{.green} [red]{.red} fruit |

For more information, refer to our [Clarifying Descriptions](clarifying-descriptions.md) guide.
...
| xſɕʃɤı [ɕı]{.green} [ƨʃ]{.magenta} [ɞx̄]{.yellow} | kuwosi [wi]{.green} [no]{.magenta} [makan]{.yellow} | inedible fruit |
...
|Likanu|Latin script|English|
|-|-|-|
| ɞſ xƨıɤ | mu kanisa | thinker |

To make the **agent** _cause_ the action rather than _do_ the action, you can replace $mu with $pan.
