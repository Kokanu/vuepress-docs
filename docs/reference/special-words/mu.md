...
It is not specified exactly what is doing the action. In the above example, it could refer to a person, an animal, or whatever else.
**mu** is often used along with sensory verbs such as $teka, $sema and $anan to talk about sensory organs (eyes, ears and nose, respectively):
